...
Codes for MSF analysis for delayed coupled systems with examples for Stuart-Landau oscillators and the Lang-Kobayashi model for coupled lasers.
See the references below for more details.

# Usage 
- `StuartLandau` : This folder contains the routines to generate the MSF surface landscape (`LK_NonDelayed.m`, `LK_SemiDiffusive.m`, `LK_DelayedDiffusive.m`  ) and the study of the dependence of the region of stability in the coupling strength (`SL_DepthSize.m`) for the Stuart-Landau model with identical indegrees.

- `LangKobayashi` : This folder contains the routines to generate the MSF surface landscape (`LK_NonDiffusive.m`) and the study of the dependence of the region of stability in the coupling strength (`LK_DepthSize.m`) for the Lang-Kobayashi model with identical indegrees.
