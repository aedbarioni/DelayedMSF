% SLdelayeddiffusive
%% MSF landscape for delayed diffusive Stuart-Landau oscillators
...
%% Parameters
lambda = 0.1;
omega = 0.25; % 0.12; % -0.28; % 0.12; %
gamma = -4.42; 
tau =  input('tau: '); %  %0.5; % 1.8*pi; %%% Modified
...
%% Fixed point
Omega0 = omega - lambda*gamma;  % omega is the initial guess
